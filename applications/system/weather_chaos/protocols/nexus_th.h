...
/**
 * Allocate WSProtocolEncoderNexus_TH.
 * @param environment Pointer to a SubGhzEnvironment instance
 * @return WSProtocolEncoderNexus_TH* pointer to a WSProtocolEncoderNexus_TH instance
 */
void* ws_protocol_encoder_nexus_th_alloc(SubGhzEnvironment* environment);

/**
 * Free WSProtocolEncoderNexus_TH.
 * @param context Pointer to a WSProtocolEncoderNexus_TH instance
 */
void ws_protocol_encoder_nexus_th_free(void* context);

/**
 * Deserialize and generate an upload to send (expects Protocol/Bit/Key/Repeat fields).
 * @param context Pointer to a WSProtocolEncoderNexus_TH instance
 * @param flipper_format Pointer to a FlipperFormat instance
 * @return status
 */
