...
void weather_station_scene_about_on_enter(void* context) {
    ...
    furi_string_cat_printf(temp_str, "Co-developed by: %s\n", WS_CO_DEVELOPED);
    furi_string_cat_printf(temp_str, "%s\n\n", WS_INSPIRED_BY);

    furi_string_cat_printf(temp_str, "\e#%s\n", "Description");
    furi_string_cat_printf(
        temp_str,
        "Listens in on SubGhz\nweather sensors, and for\na growing set of them can\nalso forge and transmit\nfake readings of its own.\n\n");
