...
#define ROLLJAM_PSA_BF_PLUGIN_APP_ID      "rolljam_psa_bf_plugin"
#define ROLLJAM_PSA_BF_PLUGIN_API_VERSION 1U
...
typedef enum {
    RollJamPsaBfContextReceiverInfo,
    RollJamPsaBfContextSubDecode,
} RollJamPsaBfContext;
...
typedef struct {
    ...
    RollJamHistory* (*get_history)(void* app);
...
typedef struct {
    ...
    void (*set_host_api)(const RollJamPsaBfHostApi* api);
    bool (*needs_bruteforce)(void* app, RollJamPsaBfContext ctx);
    bool (*is_running)(void* app);
    void (*on_scene_enter)(void* app, RollJamPsaBfContext ctx);
    bool (*on_scene_event)(void* app, RollJamPsaBfContext ctx, SceneManagerEvent event);
    void (*on_scene_exit)(void* app, RollJamPsaBfContext ctx);
    bool (*widget_left_should_bruteforce)(void* app, RollJamPsaBfContext ctx);
    void (*context_release)(void* app);
} RollJamPsaBfPlugin;

extern const RollJamPsaBfPlugin rolljam_psa_bf_plugin;
